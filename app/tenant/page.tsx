      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-grow">
        ...
        {!loadingRentals &&
          rentals.map((rental, index) => {
            const rentAmount =
              Number(rental.account.rentAmount) / Math.pow(10, 9);
            const depositAmount =
              Number(rental.account.depositAmount) / Math.pow(10, 9);
            ...
            return (
              <div
                key={index}
                className="bg-white dark:bg-gray-900 dark:text-blue-100 rounded-lg shadow-lg p-6 mb-8"
              >
                <div className="flex justify-between items-start mb-6">
                  <h2 className="text-2xl font-bold">
                    Rental Agreement #{rental.account.propertyId.toString()}
                  </h2>
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-semibold ${
                      rental.account.isActive
                        ? "bg-green-100 text-green-600 dark:bg-green-900/70 dark:text-green-300"
                        : "bg-gray-100 text-gray-600 dark:bg-gray-900 dark:text-blue-300"
                    }`}
                  >
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono">
                          {rental.account.propertyId.toString()}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-blue-200">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">
                          {rental.account.paymentCount.toString()}
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 rounded-lg font-semibold ${
                        loading || !rental.account.isActive
                          ? "bg-gray-300 text-gray-500 cursor-not-allowed dark:bg-blue-950/40 dark:text-blue-300"
                          : "bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-900 dark:hover:bg-blue-800 dark:text-blue-100"
                      }`}
                    >
                      {loading
                        ? "Processing..."
                        : `Pay Rent (${rentAmount} SOL)`}
                    </button>
                    <a
                      href={`https://explorer.solana.com/address/${rental.publicKey.toString()}?cluster=devnet`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 bg-gray-100 text-gray-700 py-2 rounded-lg hover:bg-gray-200 font-semibold text-center dark:bg-gray-800 dark:text-blue-100 dark:hover:bg-gray-700"
                    >
                      View on Explorer
                    </a>
                  </div>
                ...
                <div className="mt-6 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="bg-blue-100 dark:bg-blue-950/50 text-blue-600 dark:text-blue-200 px-3 py-1 rounded-lg text-sm font-semibold">
                      Protected
                    </div>
                  </div>
                </div>
        ...
        {!loadingRentals && (
          <div className="mt-8 text-center">
            <Link
              href="/properties"
              className="text-blue-600 hover:text-blue-700 font-semibold dark:text-blue-200 dark:hover:text-blue-100"
            >
              Browse More Properties →
            </Link>
          </div>
